...
import i0 from './../../public/sjea.jpg'
...
export default function page() {
  return (
    <div className='header'>
        <h1 className='text-center justify-center mt-5 text-blue-700 text-8xl text font-mono shadow-lg shadow-blue-500'>EARLY LIFE</h1>
    <div className='body flex flex-row flex-initial mt-5 '>
    <div className='w-1/4'><Image className='ml-3' src={i0} width={400} height={400}></Image></div>
    <div className='text flex-column ml-10 w-3/4 h-32'>
    <p className='text-slate-300 tracking-widest'><div className='t1 font-semibold text-white'> Family </div> <br></br>
...
Schieble requested that her son be adopted by college graduates. A lawyer and his wife were selected, but they withdrew after discovering that the baby was a boy, so Jobs was instead adopted by Paul Reinhold and Clara (née Hagopian) Jobs. Paul Jobs was the son of a dairy farmer; after dropping out of high school, he worked as a mechanic, then joined the U.S. Coast Guard. When his ship was decommissioned, he met Clara Hagopian, an American of Armenian descent, and the two were engaged ten days later, in March 1946, and married that same year. The couple moved to Wisconsin, then Indiana, where Paul Jobs worked as a machinist and later as a car salesman. Since Clara missed San Francisco, she convinced Paul to move back. There, Paul worked as a repossession agent, and Clara became a bookkeeper. In 1955, after having an ectopic pregnancy, the couple looked to adopt a child. Since they lacked a college education, Schieble initially refused to sign the adoption papers, and went to court to request that her son be removed from the Jobs household and placed with a different family, but changed her mind after Paul and Clara promised to pay for their son's college tuition.</p><br></br>

<p className='text-slate-300 tracking-widest'><div className='t1 font-semibold text-white'> Infancy </div><br></br>In his youth, Jobs's parents took him to a Lutheran church. When Steve was in high school, Clara admitted to his girlfriend, Chrisann Brennan, that she "was too frightened to love [Steve] for the first six months of his life … I was scared they were going to take him away from me. Even after we won the case, Steve was so difficult a child that by the time he was two I felt we had made a mistake. I wanted to return him." When Chrisann shared this comment with Steve, he stated that he was already aware,and later said he had been deeply loved and indulged by Paul and Clara. Many years later, Jobs's wife Laurene also noted that "he felt he had been really blessed by having the two of them as parents". Jobs would "bristle" when Paul and Clara were referred to as his "adoptive parents", and he regarded them as his parents "1,000%". Jobs referred to his biological parents as "my sperm and egg bank. That's not harsh, it's just the way it was, a sperm bank thing, nothing more."</p> <br></br>

<p className='text-slate-300 tracking-widest'><div className='t1 font-semibold text-white'> Childhood</div> <br></br>
...
Childhood family home of Steve Jobs on Crist Drive in Los Altos, California, and the original site of Apple Computer. The home was added to a list of historic Los Altos sites in 2013.
...
The Jobs family was not affluent, and only by expending all their savings were they able to buy a new home in 1967, allowing Steve to change schools. The new house (a three-bedroom home on Crist Drive in Los Altos, California) was in the better Cupertino School District, Cupertino, California,[23] and was embedded in an environment even more heavily populated with engineering families than the Mountain View area was. The house was declared a historic site in 2013, as the first site of Apple Computer. As of 2013, it was owned by Jobs's sister, Patty, and occupied by his stepmother, Marilyn.
...
<p className='text-slate-300 tracking-widest'><div className='t1 font-semibold text-white'> Homestead High</div> <br></br>The location of the Los Altos home meant that Jobs would be able to attend nearby Homestead High School, which had strong ties to Silicon Valley.[12] He began his first year there in late 1968 along with Bill Fernandez, who introduced Jobs to Steve Wozniak, and would become Apple's first employee. Neither Jobs nor Fernandez (whose father was a lawyer) came from engineering households and thus decided to enroll in John McCollum's Electronics I class. Jobs had grown his hair long and become involved in the growing counterculture, and the rebellious youth eventually clashed with McCollum and lost interest in the class.
...
<p className='text-slate-300 tracking-widest'><div className='t1 font-semibold text-white'> Reed College</div><br></br>
In September 1972, Jobs enrolled at Reed College in Portland, Oregon. He insisted on applying only to Reed, although it was an expensive school that Paul and Clara could ill afford. Jobs soon befriended Robert Friedland,[39] who was Reed's student body president at that time. Brennan remained involved with Jobs while he was at Reed.
